...
public:
    virtual void rbTreeEvent(typename IRBTreeDumper<Element,Compar>::RBTreeDumperEvent ev, typename IRBTreeDumper<Element,Compar>::TTree* tr, typename IRBTreeDumper<Element,Compar>::TTreeNode* nd) override
    {
