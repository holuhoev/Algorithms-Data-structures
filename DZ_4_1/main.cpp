...
int main(int argc, char* argv[])
{
    ...
    try
    {
        ...
        journal1.parseLog("/Users/evgenijlebedev/ClionProjects/DZ_4_1/test1.log");
        testJournal(journal1, "e-maxx.ru", TimeStamp(2015, 6, 10, 10, 33, 1), TimeStamp(2015, 6, 10, 10, 33, 4));

        // Test #2
        JournalNetActivity<5> journal2;
        journal2.parseLog("/Users/evgenijlebedev/ClionProjects/DZ_4_1/test2.log");
        ...
        tick();
        journal3.parseLog("/Users/evgenijlebedev/ClionProjects/DZ_4_1/test3.log");
        tack("Parsing test3.log");
        testJournal(journal3, "verisicretproxi.com", TimeStamp(2015, 6, 10, 12, 27, 45),
                    TimeStamp(2015, 6, 10, 12, 27, 59));

        // Test #4
        JournalNetActivity<250> journal4;
        tick();
        journal4.parseLog("/Users/evgenijlebedev/ClionProjects/DZ_4_1/test4.log");
